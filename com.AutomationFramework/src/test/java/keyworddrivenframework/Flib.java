...
public class Flib {
	...
	public String readPropertyData(String CommanData, String key) throws IOException {

		FileInputStream fis = new FileInputStream(CommanData); // To provide the path of excel file
